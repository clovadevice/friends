...
/* Dummy */
#define RT5640_REC_L2_MIXER_DUMMY		0xec
#define RT5640_REC_R2_MIXER_DUMMY		0xee
...
#define RT5640_I2S_CLK_CON_MASK		(0x1 << 0)
#define RT5640_I2S_CLK_CON_GATE		(0x0)
#define RT5640_I2S_CLK_CON_ENABLE	(0x1)
