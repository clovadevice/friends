 ...
 * Author: WSShim <wsshim@infomark.co.kr>
 *
...
//#define USE_EQ
//#define USE_ASRC
#define VERSION "1.0.2 alsa 1.0.25"
...
static int rt5640_volatile_register(struct snd_soc_codec *codec, unsigned int reg);
static int rt5640_readable_register(struct snd_soc_codec *codec, unsigned int reg);
...
static struct rt5640_init_reg init_list[] = {
#ifdef USE_ASRC
	{RT5640_GEN_CTRL1	, 0x3471},//fa[12:13] = 1'b; fa[8~11]=1; fa[0]=1
	{RT5640_JD_CTRL		, 0x0003},
#else
	{RT5640_GEN_CTRL1	, 0x0401/*0x3401*/},//fa[12:13] = 1'b; fa[8~11]=1; fa[0]=1
#endif
	...
	{RT5640_PRIV_INDEX	, 0x003d},//PR3d[12] = 1'b; PR3d[9] = 1'b 
	...
	{RT5640_I2S2_SDP	, 0x0000}, // I2S2 Master Mode, I2S Format
#if defined(CONFIG_SND_SOC_RT5642_MODULE) || defined(CONFIG_SND_SOC_RT5642)
	{RT5640_I2S1_SDP	, 0xe000},
	{RT5640_I2S2_SDP	, 0x8040},
#endif
#ifdef BYPASS_DSP
	{RT5640_DSP_PATH2	, 0x0c00},
#else
	{RT5640_DSP_PATH2	, 0x0000},
	{RT5640_GEN_CTRL2	, 0x0000}, //MX-FB for RxDP source
#endif
	/*record*/
	{RT5640_IN1_IN2		, 0x5080},//IN1 boost 40db and differential mode
	{RT5640_IN3_IN4		, 0x0500},//IN2 boost 40db and signal ended mode
	{RT5640_REC_L2_MIXER_DUMMY, 0x007d},//Mic1 -> RECMIXL
	{RT5640_REC_R2_MIXER_DUMMY, 0x007d},//Mic1 -> RECMIXR
	{RT5640_STO_ADC_MIXER	, 0x3020},//ADC -> Sto ADC mixer
	{RT5640_MONO_ADC_MIXER  , 0x2020},
...
static const u16 rt5640_reg[RT5640_VENDOR_ID2 + 1] = {
	...
	[RT5640_DIG_INF_DATA] = 0x0000,
	[RT5640_REC_L1_MIXER] = 0x0000,
	[RT5640_REC_L2_MIXER] = 0x007f,
	[RT5640_REC_R1_MIXER] = 0x0000,
	...
	struct snd_soc_codec *codec, unsigned int reg)
{
	...
	case RT5640_REC_L2_MIXER_DUMMY:
	case RT5640_REC_R2_MIXER_DUMMY:
 ...
 */
int rt5640_headset_detect(struct snd_soc_codec *codec, int jack_insert, bool stream_start)
{
	#if 0
	int jack_type;
	int sclk_src = 0;
	...
	{
		if(jack_insert) {
        	snd_soc_update_bits(codec, RT5640_MONO_OUT, RT5640_L_MUTE, RT5640_L_MUTE);
	...
	pr_info("[%s] %s\n", __func__, jack_insert?"Jack inserted":"Jack unpluged");
	/*
	if(jack_insert)
		snd_soc_update_bits(codec, RT5640_MONO_OUT, RT5640_L_MUTE, RT5640_L_MUTE);	
	else 
...
static int rt5640_dmic1_src_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);

	ucontrol->value.integer.value[0] = rt5640->dmic1_src;

	return 0;
}

static int rt5640_dmic1_src_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);

	if (rt5640->dmic1_src == ucontrol->value.integer.value[0])
		return 0;

	rt5640->dmic1_src = ucontrol->value.integer.value[0];
	switch (rt5640->dmic1_src) {
	case 0: /* Both */
		snd_soc_update_bits(codec, RT5640_DMIC,
			RT5640_DMIC_1L_LH_MASK | RT5640_DMIC_1R_LH_MASK,
			RT5640_DMIC_1L_LH_FALLING | RT5640_DMIC_1R_LH_RISING);
	...
	case 1: /* Left */
		snd_soc_update_bits(codec, RT5640_DMIC,
			RT5640_DMIC_1L_LH_MASK | RT5640_DMIC_1R_LH_MASK,
			RT5640_DMIC_1L_LH_FALLING | RT5640_DMIC_1R_LH_FALLING);
		break;

	case 2: /* Right */
		snd_soc_update_bits(codec, RT5640_DMIC,
			RT5640_DMIC_1L_LH_MASK | RT5640_DMIC_1R_LH_MASK,
			RT5640_DMIC_1L_LH_RISING | RT5640_DMIC_1R_LH_RISING);
		break;
...
static const char *rt5640_dmic1_src_mode[] = {"Both", "Left", "Right"};

static const SOC_ENUM_SINGLE_DECL(rt5640_dmic1_src_enum, 0, 0, rt5640_dmic1_src_mode);
...
static const struct snd_kcontrol_new rt5640_rec_l_mix[] = {
	SOC_DAPM_SINGLE("HPOL Switch", RT5640_REC_L2_MIXER_DUMMY,
			RT5640_M_HP_L_RM_L_SFT, 1, 1),
	SOC_DAPM_SINGLE("INL Switch", RT5640_REC_L2_MIXER_DUMMY,
	...
	SOC_DAPM_SINGLE("BST4 Switch", RT5640_REC_L2_MIXER_DUMMY,
			RT5640_M_BST4_RM_L_SFT, 1, 1),
	SOC_DAPM_SINGLE("BST3 Switch", RT5640_REC_L2_MIXER_DUMMY,
			RT5640_M_BST3_RM_L_SFT, 1, 1),
	SOC_DAPM_SINGLE("BST2 Switch", RT5640_REC_L2_MIXER_DUMMY,
	...
	SOC_DAPM_SINGLE("BST2 Switch", RT5640_REC_L2_MIXER_DUMMY,
			RT5640_M_BST4_RM_L_SFT, 1, 1),
#endif
	SOC_DAPM_SINGLE("BST1 Switch", RT5640_REC_L2_MIXER_DUMMY,
			RT5640_M_BST1_RM_L_SFT, 1, 1),
	SOC_DAPM_SINGLE("OUT MIXL Switch", RT5640_REC_L2_MIXER_DUMMY,
			RT5640_M_OM_L_RM_L_SFT, 1, 1),
};

static const struct snd_kcontrol_new rt5640_rec_r_mix[] = {
	SOC_DAPM_SINGLE("HPOR Switch", RT5640_REC_R2_MIXER_DUMMY,
			RT5640_M_HP_R_RM_R_SFT, 1, 1),
	SOC_DAPM_SINGLE("INR Switch", RT5640_REC_R2_MIXER_DUMMY,
			RT5640_M_IN_R_RM_R_SFT, 1, 1),
#if defined(CONFIG_SND_SOC_RT5643_MODULE) || defined(CONFIG_SND_SOC_RT5643) || \
	defined(CONFIG_SND_SOC_RT5646_MODULE) || defined(CONFIG_SND_SOC_RT5646)
	SOC_DAPM_SINGLE("BST4 Switch", RT5640_REC_R2_MIXER_DUMMY,
			RT5640_M_BST4_RM_R_SFT, 1, 1),
	SOC_DAPM_SINGLE("BST3 Switch", RT5640_REC_R2_MIXER_DUMMY,
			RT5640_M_BST3_RM_R_SFT, 1, 1),
	SOC_DAPM_SINGLE("BST2 Switch", RT5640_REC_R2_MIXER_DUMMY,
	...
	SOC_DAPM_SINGLE("BST2 Switch", RT5640_REC_R2_MIXER_DUMMY,
			RT5640_M_BST4_RM_R_SFT, 1, 1),
#endif
	SOC_DAPM_SINGLE("BST1 Switch", RT5640_REC_R2_MIXER_DUMMY,
			RT5640_M_BST1_RM_R_SFT, 1, 1),
	SOC_DAPM_SINGLE("OUT MIXR Switch", RT5640_REC_R2_MIXER_DUMMY,
...
static int rt5640_recmixl_event(struct snd_soc_dapm_widget *w,
	struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	unsigned int value;
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		value = snd_soc_read(codec, RT5640_REC_L2_MIXER_DUMMY);
		snd_soc_update_bits(codec, RT5640_REC_L2_MIXER, 0x7f, value);
		break;

	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT5640_REC_L2_MIXER, 0x7f, 0x7f);
		break;
...
static int rt5640_recmixr_event(struct snd_soc_dapm_widget *w,
	struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	unsigned int value;
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		value = snd_soc_read(codec, RT5640_REC_R2_MIXER_DUMMY);
		snd_soc_update_bits(codec, RT5640_REC_R2_MIXER, 0x7f, value);
		break;

	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT5640_REC_R2_MIXER, 0x7f, 0x7f);
		break;
...
static const struct snd_soc_dapm_widget rt5640_dapm_widgets[] = {
	...
	SND_SOC_DAPM_PGA("BST3", RT5640_PWR_ANLG2,
		RT5640_PWR_BST2_BIT, 0, NULL, 0),
#endif
	SND_SOC_DAPM_SUPPLY("BST1 ext power", RT5640_GEN_CTRL1,
		9, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("BST2 ext power", RT5640_GEN_CTRL1,
		8, 0, NULL, 0),
	...
	/* REC Mixer */
	SND_SOC_DAPM_MIXER_E("RECMIXL", RT5640_PWR_MIXER, RT5640_PWR_RM_L_BIT,
		0, rt5640_rec_l_mix, ARRAY_SIZE(rt5640_rec_l_mix),
		rt5640_recmixl_event, SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_MIXER_E("RECMIXR", RT5640_PWR_MIXER, RT5640_PWR_RM_R_BIT,
		0, rt5640_rec_r_mix, ARRAY_SIZE(rt5640_rec_r_mix),
		rt5640_recmixr_event, SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	/* ADCs */
	...
	SND_SOC_DAPM_SUPPLY("mono left filter", /*RT5640_PWR_DIG2*/SND_SOC_NOPM,
		/*RT5640_PWR_ADC_MF_L_BIT*/0, 0, NULL, 0),
	SND_SOC_DAPM_MIXER("Mono ADC MIXL", SND_SOC_NOPM, 0, 0,
		rt5640_mono_adc_l_mix, ARRAY_SIZE(rt5640_mono_adc_l_mix)),
	SND_SOC_DAPM_SUPPLY("mono right filter", /*RT5640_PWR_DIG2*/SND_SOC_NOPM,
		/*RT5640_PWR_ADC_MF_R_BIT*/0, 0, NULL, 0),
	...
	SND_SOC_DAPM_ADC("IF1 ADC L", NULL, RT5640_ADC_DIG_VOL,
		RT5640_L_MUTE_SFT, 1),
	SND_SOC_DAPM_ADC("IF1 ADC R", NULL, RT5640_ADC_DIG_VOL,
		RT5640_R_MUTE_SFT, 1),

	
	SND_SOC_DAPM_SUPPLY("I2S2", /*RT5640_PWR_DIG1*/SND_SOC_NOPM,
		/*RT5640_PWR_I2S2_BIT*/0, 0, NULL, 0),

	SND_SOC_DAPM_PGA("IF2 DAC", SND_SOC_NOPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("IF2 DAC L", SND_SOC_NOPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("IF2 DAC R", SND_SOC_NOPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("IF2 ADC", SND_SOC_NOPM, 0, 0, NULL, 0),
	SND_SOC_DAPM_ADC("IF2 ADC L", NULL, /*RT5640_GEN_CTRL1*/SND_SOC_NOPM, 13, /*1*/0),
	SND_SOC_DAPM_ADC("IF2 ADC R", NULL, /*RT5640_GEN_CTRL1*/SND_SOC_NOPM, 12, /*1*/0),
	...
	SND_SOC_DAPM_MUX("DAC R2 Mux", SND_SOC_NOPM, 0, 0,
				&rt5640_dac_r2_mux),
	SND_SOC_DAPM_PGA("DAC L2 Volume", /*RT5640_PWR_DIG1*/SND_SOC_NOPM,
			/*RT5640_PWR_DAC_L2_BIT*/0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("DAC R2 Volume", /*RT5640_PWR_DIG1*/SND_SOC_NOPM,
			/*RT5640_PWR_DAC_R2_BIT*/0, 0, NULL, 0),
	...
	SND_SOC_DAPM_DAC("DAC L2", NULL, /*RT5640_PWR_DIG1*/SND_SOC_NOPM,
			/*RT5640_PWR_DAC_L2_BIT*/0, 0),
	SND_SOC_DAPM_DAC_E("DAC R1", NULL, RT5640_PWR_DIG1,
			RT5640_PWR_DAC_R1_BIT, 0, rt5640_dac1_event,
			SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_DAC("DAC R2", NULL, /*RT5640_PWR_DIG1*/SND_SOC_NOPM,
			/*RT5640_PWR_DAC_R2_BIT*/0, 0),
	/* SPK/OUT Mixer */
...
static const struct snd_soc_dapm_route rt5640_dapm_routes[] = {
	...
	{"BST1", NULL, "IN1P"},
	{"BST1", NULL, "IN1N"},
	{"BST1", NULL, "BST1 ext power"},
	{"BST2", NULL, "IN2P"},
	{"BST2", NULL, "IN2N"},
	{"BST2", NULL, "BST2 ext power"},
	{"BST3", NULL, "IN3P"},
	{"BST3", NULL, "IN3N"},
#if defined(CONFIG_SND_SOC_RT5643_MODULE) || defined(CONFIG_SND_SOC_RT5643) || \
	defined(CONFIG_SND_SOC_RT5646_MODULE) || defined(CONFIG_SND_SOC_RT5646)
			...
			enum snd_soc_bias_level level)
{
...
#endif
		if(rt5640->gpio_speaker_enable)
			gpio_direction_output(rt5640->gpio_speaker_enable, 1);
		break;
	...
	case SND_SOC_BIAS_STANDBY:
		...
		if (SND_SOC_BIAS_OFF == codec->dapm.bias_level) {
			...
			snd_soc_update_bits(codec, RT5640_PWR_DIG1,
		        RT5640_PWR_I2S2 | RT5640_PWR_DAC_L2 | RT5640_PWR_DAC_R2,
        		RT5640_PWR_I2S2 | RT5640_PWR_DAC_L2 | RT5640_PWR_DAC_R2);	
				
			snd_soc_update_bits(codec, RT5640_PWR_DIG2,
				RT5640_PWR_ADC_MF_L | RT5640_PWR_ADC_MF_R,
				RT5640_PWR_ADC_MF_L | RT5640_PWR_ADC_MF_R);
			
#ifdef USE_ASRC
			snd_soc_write(codec, RT5640_GEN_CTRL1, 0x3471);
#else
			snd_soc_write(codec, RT5640_GEN_CTRL1, /*0x3401*/0x0401);
#endif
	...
	case SND_SOC_BIAS_OFF:
		...
		if(rt5640->gpio_speaker_enable)
			gpio_direction_output(rt5640->gpio_speaker_enable, 0);
			
		snd_soc_write(codec, RT5640_DEPOP_M1, 0x0004);
		snd_soc_write(codec, RT5640_DEPOP_M2, 0x1100);
		snd_soc_write(codec, RT5640_GEN_CTRL1, 0x3401);
...
int rt5640_cdc_mclk_enable(struct snd_soc_codec *codec, int enable, bool dapm)
{
    int ret = 0;
    struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
    ...
    {
        ret = -EINVAL;
        pr_err("[%s] Error Ext Clk is null\n", __func__);
        goto ERROR_RT5640_CDC_MCLK_ENABLE;
    }

    if(enable)
    {
        ret = clk_prepare_enable(rt5640->ext_clk);
        if(ret)
        {
            pr_err("[%s] Error Clk Prepare\n", __func__);
            goto ERROR_RT5640_CDC_MCLK_ENABLE;
        }
		pr_info("[%s] Enable Ext Clk\n", __func__);
    }
    else
    {
        //pr_info("[%s] Disable Ext Clk\n", __func__);
        //clk_disable_unprepare(rt5640->ext_clk);
    }
ERROR_RT5640_CDC_MCLK_ENABLE:
    return ret;
}
EXPORT_SYMBOL(rt5640_cdc_mclk_enable);
...
static DEVICE_ATTR(codec_reg_adb, 0777, rt5640_codec_adb_show, rt5640_codec_adb_store);
...
static int rt5640_probe(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, RT5640_PWR_ANLG1,
		RT5640_PWR_VREF1 | RT5640_PWR_VREF2 |
		RT5640_PWR_MB | RT5640_PWR_BG,
		RT5640_PWR_VREF1 | RT5640_PWR_VREF2 |
		RT5640_PWR_MB | RT5640_PWR_BG);
	msleep(100);
	snd_soc_update_bits(codec, RT5640_PWR_ANLG1,
		    ...
		    const struct i2c_device_id *id)
{
	...
	ext_clk = clk_get(&i2c->dev, "ext_clk");
    if (IS_ERR(ext_clk)) {
        pr_info("[%s] clk get %s failed\n", __func__, "ext_clk");
        return -ENOMEM;
    }
    rt5640->ext_clk = ext_clk;
    
    if(i2c->dev.of_node){
    	rt5640->gpio_speaker_enable = of_get_named_gpio(i2c->dev.of_node, "speaker-gpio", 0);
    	if(gpio_is_valid(rt5640->gpio_speaker_enable)) {
    		ret = gpio_request(rt5640->gpio_speaker_enable, "rt5640-speaker-enable");
    		if(ret) {
    			pr_err("[%s] speaker enable pin invalied", __func__);    
    			rt5640->gpio_speaker_enable = (int)NULL;		
    		}
    		else {
    			gpio_direction_output(rt5640->gpio_speaker_enable, 1);
    		}    			
...
const struct of_device_id rt5640_dt_ids[] = {
	{ .compatible = "realtek,rt5640", },
	{ }
};
EXPORT_SYMBOL_GPL(rt5640_dt_ids);
MODULE_DEVICE_TABLE(of, rt5640_dt_ids);

struct i2c_driver rt5640_i2c_driver = {
	.driver = {
		.name = "rt5640",
		.owner = THIS_MODULE,
		.of_match_table = of_match_ptr(rt5640_dt_ids),
	},
