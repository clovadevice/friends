...
ifneq ($(filter if_s300n if_s301n, $(TARGET_PRODUCT)),)
KERNEL_CFLAGS += -DCONFIG_TARGET_PRODUCT_IF_S300N
endif
ifneq ($(filter if_s600n, $(TARGET_PRODUCT)),)
KERNEL_CFLAGS += -DCONFIG_TARGET_PRODUCT_IF_S600N
endif
ifneq ($(filter if_s600nl, $(TARGET_PRODUCT)),)
KERNEL_CFLAGS += -DCONFIG_TARGET_PRODUCT_IF_S600NL
endif
## INFOMARK
...
$(TARGET_PREBUILT_INT_KERNEL): $(KERNEL_OUT) $(KERNEL_HEADERS_INSTALL)
	...
	$(MAKE) -C kernel O=../$(KERNEL_OUT) ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) KCFLAGS="$(KERNEL_CFLAGS)" TARGET_PRODUCT=$(TARGET_PRODUCT)
	$(MAKE) -C kernel O=../$(KERNEL_OUT) ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) KCFLAGS="$(KERNEL_CFLAGS)" TARGET_PRODUCT=$(TARGET_PRODUCT) modules
